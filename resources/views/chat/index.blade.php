    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="app-chat.html"><i class="feather icon-message-square"></i><span
                ...
                <div class="sidebar">
                                    ...
                                    <li class="pb-50">
                                        <fieldset>
                                            <div class="vs-radio-con vs-radio-success">
                                                <input type="radio" name="userStatus" value="online"
                                                    checked="checked">
                                                <span class="vs-radio">
                    ...
                    <div class="sidebar-content card">
                        ...
                        <div id="users-list" class="chat-user-list list-group position-relative">
                            ...
                            <ul class="chat-users-list-wrapper media-list user-list-div">
                                {{-- @include('chat.ajax.chat_list') --}}
                            </ul>
                                ...
                                <div class="chat_navbar">
                                    <header class="chat_header d-flex justify-content-between align-items-center p-1">
                                        <div class="vs-con-items d-flex align-items-center">
                                            ...
                                            <h6 class="mb-0 chat-nav-name">Felecia Rower</h6>
                                        </div>
